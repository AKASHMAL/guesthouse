...
//echo($_POST['address1']+$_POST['address2']+$_POST['address3']);
...
$s1="INSERT INTO users (first_name,last_name,day_phone,user_name,user_password,address,city,country,payment_type)VALUES('".$fn."','".$ln."','".$phone."','".$email."','".$pass."','".$add."','".$city."','".$country."','".$intr."')";
...
<table>
 <form method="POST" name="signupform" action="index.php" onSubmit="return signup();" >
	...
	<tr>
		...
		<td><input name="daytimephone" type="text" id="daytimephone" size="40" class="phone" />		</td>
	</tr>
	<tr>
    ...
    <br>
	<tr>
	  <td height="40">Address 1 </td>
	  <td><input name="address1" type="text" id="address1" size="40" /></td>
	  </tr>
	<tr>
	  <td height="40">Address 2 </td>
	  <td><input name="address2" type="text" id="address2" size="40" /></td>
	  </tr>
	<tr>
	  <td height="40">Address 3 </td>
	  <td><input name="address3" type="text" id="address3" size="40" /></td>
	  </tr>
	<tr>
	...
	<tr>
		...
		<input type="radio" name="usertype" id="usertype2" value="paypal" />Paypal/CreditCard		</td>
	</tr>
	<tr>
